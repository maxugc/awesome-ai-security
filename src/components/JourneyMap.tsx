...
type AccentColor = 'purple' | 'rose' | 'cyan' | 'amber';
...
export const JourneyMap: React.FC<JourneyMapProps> = ({ onNodeSelect, selectedNodeId }) => {
    ...
    // Sort resources by rating, then narrow them with the search box.
                ...
                <div className="mx-auto max-w-7xl">
                    <div className="scrollbar-hide flex items-center gap-2 overflow-x-auto">
                        ...
                        <div className="flex flex-shrink-0 items-center gap-0.5 rounded-lg border border-[var(--border-color)] bg-[var(--bg-tertiary)] p-0.5">
                            ...
                            <TrackButton
                                compact
                                active={activeTrack === 'hacking_with_ai'}
                                accent="cyan"
            ...
            <div className="mx-auto max-w-7xl px-5 py-8 sm:px-6">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    ...
                    <div className="space-y-6 lg:col-span-1">
                        ...
                        <Divider>Choose your path</Divider>
                            ...
                            {journeyStructure.lanes[activeTrack].nodes.map((nodeId) => {
                                ...
                                return (
                                    <TopicCard
                                        ...
                                        isSelected={selectedNodeId === nodeId}
                                        onClick={() => onNodeSelect(node)}
                                        accentColor={activeTrack === 'hacking_ai' ? 'rose' : 'cyan'}
                                    />
                                );
                            })}
                        </div>
                        ...
                        <div className="space-y-1.5">
                            <SectionLabel>Standards &amp; community</SectionLabel>
...
const TrackButton: React.FC<{
    ...
    <button
        ...
        className={clsx(
            ...
            compact ? 'px-2 py-1 text-[11px]' : 'flex-1 px-3 py-2 text-xs',
...
const TopicCard: React.FC<{
    ...
    stepNumber?: number;
}> = ({ node, isSelected, onClick, accentColor = 'purple', stepNumber }) => (
    <motion.button
        onClick={onClick}
        whileHover={{ x: 3 }}
